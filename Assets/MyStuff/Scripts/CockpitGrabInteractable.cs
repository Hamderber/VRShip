...
public class CockpitGrabInteractable : XRBaseInteractable//MonoBehaviour
{
    public Rigidbody physicsRegerence;
    public Rigidbody selfRigidBody;
    public GameObject faceThis;

    private void CounteractShipPhysics()
    {
        selfRigidBody.velocity -= physicsRegerence.velocity;
    }

    private void FixedUpdate()
    {
        //transform.
        //CounteractShipPhysics();
        Debug.Log($"Self velocity: {selfRigidBody.velocity} Reference velocity: {physicsRegerence.velocity}");
    }
